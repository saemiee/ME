...
final class TagDataManager {
    ...
    func makeTagData() {
        tagDataArray = [
            ...
            Tag(tagImage: UIImage(named: "dancing"), tagName: "댄싱머신",tagDescription: "둠칫둠칫 Best Dancer!"),
            ...
            Tag(tagImage: UIImage(named: "personBiking"), tagName: "Best 라이더", tagDescription: "바퀴 두 개만 있다면 어디든 ~"),
