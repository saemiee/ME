...
final class ShopDataManager {
    ...
    func makeShopData() {
        shopDataArray = [
            ...
            Shop(productImage: UIImage(named: "iceBox"), brandName: "스타벅스", productName: "아이스 콜드 브루 T", price: 1),
            Shop(productImage: UIImage(named: "iceBox"), brandName: "스타벅스", productName: "아이스 돌체라떼 T", price: 1),
            Shop(productImage: UIImage(named: "iceBox"), brandName: "스타벅스", productName: "아이스 자몽 허니 블랙 티 T", price: 1),
            Shop(productImage: UIImage(named: "strawberryChocolate"), brandName: "투썸플레이스", productName: "떠먹는 스트로베리 초콜릿 생크림", price: 1),
