...
final class ShopDataManager {
    ...
    func makeShopData() {
        shopDataArray = [
            Shop(productImage: UIImage(resource: .americano), brandName: "스타벅스", productName: "아이스 아메리카노 T", price: 4500, notice: starbucksNotice),
            Shop(productImage: UIImage(resource: .icedCafeLatte), brandName: "스타벅스", productName: "아이스 카페 라떼 T", price: 5000, notice: starbucksNotice),
            Shop(productImage: UIImage(resource: .caramelMacchiato), brandName: "스타벅스", productName: "아이스 카라멜 마키아또 T", price: 5900, notice: starbucksNotice),
            Shop(productImage: UIImage(resource: .coldBrew), brandName: "스타벅스", productName: "아이스 콜드 브루 T", price: 4900, notice: starbucksNotice),
            Shop(productImage: UIImage(resource: .dolceLatte), brandName: "스타벅스", productName: "아이스 돌체라떼 T", price: 5900, notice: starbucksNotice),
            Shop(productImage: UIImage(resource: .grapefruitHoneyBlackTea), brandName: "스타벅스", productName: "자몽 허니 블랙 티 T", price: 5700, notice: starbucksNotice),
            Shop(productImage: UIImage(resource: .strawberryChocolate), brandName: "투썸플레이스", productName: "스트로베리 초콜릿 생크림", price: 6700, notice: twosomeplaceNotice),
            Shop(productImage: UIImage(resource: .iceBox), brandName: "투썸플레이스", productName: "떠먹는 아이스박스", price: 6500, notice: twosomeplaceNotice),
            Shop(productImage: UIImage(resource: .baskinRobbinsPint), brandName: "베스킨라빈스", productName: "파인트 아이스크림", price: 9800, notice: baskinrobbinsNotice),
            Shop(productImage: UIImage(resource: .injeolmiSulbing), brandName: "설빙", productName: "인절미설빙", price: 9500, notice: sulbiingNotice),
            Shop(productImage: UIImage(resource: .cyBurgerSet), brandName: "맘스터치", productName: "싸이버거 세트", price: 6900, notice: momsTouchNotice),
            Shop(productImage: UIImage(resource: .gs25), brandName: "GS25", productName: "모바일 상품권 5,000", price: 5000, notice: gs25Notice),
            Shop(productImage: UIImage(resource: .cu), brandName: "CU", productName: "모바일 상품권 5,000", price: 5000, notice: cuNotice),
            Shop(productImage: UIImage(resource: .redRepperChicken), brandName: "굽네치킨", productName: "고추바사삭 + 콜라 1.25L", price: 20000, notice: gubneNotice),
            Shop(productImage: UIImage(resource: .goldenOlive), brandName: "BBQ", productName: "황금올리브 + 콜라 1.25L", price: 22500, notice: bbqNotice),
            Shop(productImage: UIImage(resource: .honeyCombo), brandName: "교촌치킨", productName: "허니콤보 + 콜라 1.25L", price: 26000, notice: kyochonNotice)
        ]
    }
